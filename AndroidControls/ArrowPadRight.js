...
var ControllerScript:AndroidControls;
...
function Start()
{
	...
	guiTexture.pixelInset.y=buttonHeight*0.2;
...
function Update()
{	
//	if(position.x<(-0.1) || position.x>(0.1)) //keelab näpu libistamise nupul suuremas ulatuses
//	{
	...
	else
	{
		for(var i : int = 0;i < count; i++)
		{
			...
			if ( shouldLatchFinger && ( lastFingerId == -1 || lastFingerId != touch.fingerId ) )
			{
				...
				{
					gui.color.a = 1;
					ControllerScript.rightArrowPressed=true;
			...
			{	
				...
				{
					ResetJoystick();	
					ControllerScript.rightArrowPressed=false;	
				}				
			}			
		}
	}
