...
function Start()
{
	...
	MenuScript=GameObject.FindWithTag("GUI").GetComponent(InGameGUI);

	
	// Store the default rect for the gui, so we can snap back to it
	guiTexture.pixelInset.width=buttonWidth*0.7;
	guiTexture.pixelInset.height=buttonHeight*0.7;
	guiTexture.pixelInset.x=-buttonWidth*0.9;
	guiTexture.pixelInset.y=-buttonHeight*0.9;
